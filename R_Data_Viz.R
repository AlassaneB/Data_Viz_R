...
shinyApp(
  ui <- div(style = "font-family:'calibri light'", 
            dashboardPage(
              ...
              dashboardSidebar(width = 140, collapsed = FALSE,
                               sidebarMenu(
                                 menuItem("", tabName = "rdna"),
                                 menuItem(actionBttn("actiondataload", "", style = "material-circle", icon = icon("upload")), tabName = "datainput"),
                                 menuItem(actionBttn("actiondataviz", "", style = "material-circle", icon = icon("chart-bar")), tabName = "dataviz")
                               )
              ),
              dashboardBody(br(),
                            tabItems(
                                    ...
                                    fluidRow(
                                      column(width = 2,
                                             wellPanel(style = "background:#f9fbfb; border-radius:0px; border-color:white; border-width:.25px",
                                                       div(style = "margin-bottom:-1em; width:180px", selectInput("fileType_Input","", choices = c("Select" = "", ".csv/.txt" = "csvtxt", ".xlsx/.xls" = "excel", ".dbf" = "dbf", ".shp" = "shp"), selected = "csvtxt")),
                              ...
                              tabItem(tabName = "dataviz",
                                dropdownButton(jqui_resizable(box(
                                  fluidRow(
                                    column(width = 2,
                                                     shinyTree("dataviztree", search = TRUE, animation = FALSE, theme = 'proton', dragAndDrop = TRUE, themeDots = TRUE, wholerow = TRUE, themeIcons = FALSE, unique = TRUE, multiple = FALSE),
                                                     shinyTree("graphopttree", search = FALSE, animation = FALSE, theme = 'proton', dragAndDrop = TRUE, themeDots = TRUE, wholerow = TRUE, themeIcons = FALSE, unique = TRUE, multiple = FALSE),
                                                     shinyTree("colorfacettree", search = FALSE, animation = FALSE, theme = 'proton', dragAndDrop = TRUE, themeDots = TRUE, wholerow = TRUE, themeIcons = FALSE, unique = TRUE, multiple = FALSE),
                                                     shinyTree("axislabeltree", search = FALSE, animation = FALSE, theme = 'proton', dragAndDrop = TRUE, themeDots = TRUE, wholerow = TRUE, themeIcons = FALSE, unique = TRUE, multiple = FALSE)
                                      ),
                                    column(width = 8,
                                           div(style = "border-radius:0px; border-color:white", 
                                               ...
                                               withLoader(plotlyOutput("graph", height = "675px"), type = "html", loader = "dnaspin")
                                           )
                                    ),
                                    column(width = 2,
                                           hr(),
                                  ...
                                  circle = TRUE, tooltip = TRUE, label = "Exploratory Visualization",status = "success", icon = icon("chart-bar")
                                )
                              )
